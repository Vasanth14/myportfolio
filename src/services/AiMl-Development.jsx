        ...
        <>
                    ...
                    <Row>
                        <Col className="homecolleft" lg={6}>
                            <div className="bannercontent">
                                <h2 className="maintitl">AI & ML Development Services</h2>
                                <p className="content">
                                    Our mission is to deliver innovative AI and machine learning solutions that drive business growth and enhance decision-making.
                                </p>
                ...
                <Container>
                    <Row>
                        <div className="sectiontitle">
                            <h3 className="sectitl text-center">Comprehensive AI & ML Solutions</h3>
                        </div>
                        <div className="whatwesect mb-3">
                            <h2 className="sech2 text-center">Transforming Data into Intelligent Insights</h2>
                        </div>
                        <div className='servicegridbg'>
                            <div className="abtcont">
                                <Image src={what2} alt="arrow" className="whatwedoimg" />
                                <div className="aboutcomp">
                                    <h2 className="whatwedoh2">Custom AI Solutions</h2>
                                    <p className="whatwedop">Developing tailored AI applications that meet your business needs and improve operational efficiency.</p>
                                </div>
                            </div>
                            <div className="abtcont">
                                <Image src={what2} alt="arrow" className="whatwedoimg" />
                                <div className="aboutcomp">
                                    <h2 className="whatwedoh2">Machine Learning Model Development</h2>
                                    <p className="whatwedop">Creating robust machine learning models for predictive analytics and data-driven decision-making.</p>
                                </div>
                            </div>
                            <div className="abtcont">
                                <Image src={what2} alt="arrow" className="whatwedoimg" />
                                <div className="aboutcomp">
                                    <h2 className="whatwedoh2">Natural Language Processing (NLP)</h2>
                                    <p className="whatwedop">Implementing NLP solutions to enhance customer interactions and automate text analysis.</p>
                                </div>
                            </div>
                            <div className="abtcont">
                                <Image src={what2} alt="arrow" className="whatwedoimg" />
                                <div className="aboutcomp">
                                    <h2 className="whatwedoh2">Computer Vision Solutions</h2>
                                    <p className="whatwedop">Building computer vision applications for image recognition, object detection, and video analysis.</p>
                                </div>
                            </div>
                            <div className="abtcont">
                                <Image src={what2} alt="arrow" className="whatwedoimg" />
                                <div className="aboutcomp">
                                    <h2 className="whatwedoh2">AI-Powered Chatbots</h2>
                                    <p className="whatwedop">Developing intelligent chatbots that improve customer service and engagement.</p>
                                </div>
                            </div>
                        </div>
            ...
            <section className='ourservices' data-aos="fade-up">
                <Container>
                    <Row>
                        <div className="sectiontitle">
                            <h3 className="sectitl text-center">AI & ML Development Services</h3>
                        </div>
                        <div className="whatwesect mb-3">
                            <h2 className="sech2 text-center">Unlocking the Potential of AI & ML Technology</h2>
                        ...
                        <div className='servicegridbg'>
                            <div className="whatwedocont whatwedocontcust">
                                ...
                                <div className="whatwedofeatures">
                                    <h2 className="whatwedoh2">AI Development</h2>
                                    <p className="whatwedop">Crafting high-quality AI applications that provide seamless user experiences.</p>
                                </div>
                            </div>
                            <div className="whatwedocont whatwedocontcust">
                                <Image src={what2} alt="arrow" className="whatwedoimg" />
                                <div className="whatwedofeatures">
                                    <h2 className="whatwedoh2">ML Development</h2>
                                    <p className="whatwedop">Building robust AI applications tailored to your business needs.</p>
                                </div>
                            </div>
                            <div className="whatwedocont whatwedocontcust">
                                <Image src={what2} alt="arrow" className="whatwedoimg" />
                                <div className="whatwedofeatures">
                                    ...
                                    <p className="whatwedop">Creating applications that work on both AI platforms efficiently.</p>
                                </div>
                            </div>
                            <div className="whatwedocont whatwedocontcust">
                                <Image src={what2} alt="arrow" className="whatwedoimg" />
                                <div className="whatwedofeatures">
                                    ...
                                    <p className="whatwedop">Designing intuitive and engaging user interfaces for AI applications.</p>
                                </div>
                            </div>
                            <div className="whatwedocont whatwedocontcust">
                                <Image src={what2} alt="arrow" className="whatwedoimg" />
                                <div className="whatwedofeatures">
                                    <h2 className="whatwedoh2">AI App Testing</h2>
                                    <p className="whatwedop">Ensuring the quality and performance of AI applications through rigorous testing.</p>
                                </div>
                            </div>
                            <div className="whatwedocont whatwedocontcust">
                                <Image src={what2} alt="arrow" className="whatwedoimg" />
                                <div className="whatwedofeatures">
                                    ...
                                    <p className="whatwedop">Providing ongoing support and updates to keep your AI app running smoothly.</p>
                                </div>
                            </div>
                        </div>
                    </Row>
            ...
            <section className='ourprocess' data-aos="fade-up">
                ...
                <div className="sectiontitle">
                    <h3 className="sectitl text-center">Our AI & ML Development Process</h3>
                </div>
                    ...
                    <OwlCarousel className='owl-theme' {...options}>
                        <div className='steps item'>
                            ...
                            <div className='my-2'>
                                ...
                                <p className='owlp'>Understanding client needs and defining project scope for AI and ML applications.</p>
                            </div>
                        </div>
                        <div className='steps item'>
                            <div>
                            ...
                            <div className='my-2'>
                                ...
                                <p className='owlp'>Creating user-centric designs and prototypes for AI solutions.</p>
                            </div>
                        </div>
                        <div className='steps item'>
                            <div>
                            ...
                            <div className='my-2'>
                                ...
                                <p className='owlp'>Building AI and ML applications using the latest technologies and frameworks.</p>
                            </div>
                        </div>
                        <div className='steps item'>
                            <div>
                            ...
                            <div className='my-2'>
                                ...
                                <p className='owlp'>Conducting thorough testing to ensure AI application functionality and performance.</p>
                            </div>
                        </div>
                        <div className='steps item'>
                            <div>
                            ...
                            <div className='my-2'>
                                ...
                                <p className='owlp'>Launching your AI application and providing ongoing support.</p>
                            </div>
                        </div>
                    </OwlCarousel>
                </div>
            ...
            <section className="servicetech ourtechstack" id="techstacks" data-aos="fade-up">
                <Container>
                    <div className="sectiontitle">
                        <h3 className="sectitl text-center">Technologies We Use for AI & ML Development</h3>
                    </div>
                    <div className="whatwesect mb-3">
