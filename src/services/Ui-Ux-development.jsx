        ...
        <>
                    ...
                    <Row>
                        <Col className="homecolleft" lg={6}>
                            <div className="bannercontent">
                                <h2 className="maintitl">UI/UX Design Services</h2>
                                <p className="content">
                                    Our mission is to create user-centered designs that enhance user experience and drive engagement across digital platforms.
                                </p>
                ...
                <Container>
                    <Row>
                        <div className="sectiontitle">
                            <h3 className="sectitl text-center">Comprehensive UI/UX Design Solutions</h3>
                        </div>
                        <div className="whatwesect mb-3">
                            <h2 className="sech2 text-center">Transforming Ideas into Exceptional User Experiences</h2>
                        </div>
                        <div className='servicegridbg'>
                            <div className="abtcont">
                                <Image src={what2} alt="arrow" className="whatwedoimg" />
                                <div className="aboutcomp">
                                    <h2 className="whatwedoh2">User Research & Analysis</h2>
                                    <p className="whatwedop">Conducting in-depth user research to understand user needs and behaviors for informed design decisions.</p>
                                </div>
                            </div>
                            <div className="abtcont">
                                <Image src={what2} alt="arrow" className="whatwedoimg" />
                                <div className="aboutcomp">
                                    <h2 className="whatwedoh2">Wireframing & Prototyping</h2>
                                    <p className="whatwedop">Creating wireframes and interactive prototypes to visualize the user journey and interface layout.</p>
                                </div>
                            </div>
                            <div className="abtcont">
                                <Image src={what2} alt="arrow" className="whatwedoimg" />
                                <div className="aboutcomp">
                                    <h2 className="whatwedoh2">Visual Design</h2>
                                    <p className="whatwedop">Designing visually appealing interfaces that align with your brand identity and enhance user engagement.</p>
                                </div>
                            </div>
                            <div className="abtcont">
                                <Image src={what2} alt="arrow" className="whatwedoimg" />
                                <div className="aboutcomp">
                                    ...
                                    <p className="whatwedop">Conducting usability tests to gather feedback and optimize the user experience for maximum satisfaction.</p>
                                </div>
                            </div>
                            <div className="abtcont">
                                <Image src={what2} alt="arrow" className="whatwedoimg" />
                                <div className="aboutcomp">
                                    <h2 className="whatwedoh2">Responsive Design</h2>
                                    <p className="whatwedop">Developing responsive designs that provide seamless experiences across all devices and screen sizes.</p>
                                </div>
                            </div>
                        </div>
            ...
            <section className='ourservices' data-aos="fade-up">
                <Container>
                    <Row>
                        <div className="sectiontitle">
                            <h3 className="sectitl text-center">UI/UX Design Services</h3>
                        </div>
                        <div className="whatwesect mb-3">
                            <h2 className="sech2 text-center">Unlocking the Potential of Exceptional UI/UX Design</h2>
                        ...
                        <div className='servicegridbg'>
                            <div className="whatwedocont whatwedocontcust">
                                ...
                                <div className="whatwedofeatures">
                                    ...
                                    <p className="whatwedop">Crafting high-quality UI/UX designs that provide seamless user experiences.</p>
                                </div>
                            </div>
                            <div className="whatwedocont whatwedocontcust">
                                <Image src={what2} alt="arrow" className="whatwedoimg" />
                                <div className="whatwedofeatures">
                                    ...
                                    <p className="whatwedop">Designing intuitive and engaging user interfaces for UI/UX applications.</p>
                                </div>
                            </div>
                            <div className="whatwedocont whatwedocontcust">
                                <Image src={what2} alt="arrow" className="whatwedoimg" />
                                <div className="whatwedofeatures">
                                    <h2 className="whatwedoh2">UI/UX App Testing</h2>
                                    <p className="whatwedop">Ensuring the quality and performance of UI/UX applications through rigorous testing.</p>
                                </div>
                            </div>
                            <div className="whatwedocont whatwedocontcust">
                                <Image src={what2} alt="arrow" className="whatwedoimg" />
                                <div className="whatwedofeatures">
                                    ...
                                    <p className="whatwedop">Providing ongoing support and updates to keep your UI/UX app running smoothly.</p>
                                </div>
                            </div>
                        </div>
                    </Row>
            ...
            <section className='ourprocess' data-aos="fade-up">
                ...
                <div className="sectiontitle">
                    <h3 className="sectitl text-center">Our UI/UX Design Process</h3>
                </div>
                    ...
                    <OwlCarousel className='owl-theme' {...options}>
                        <div className='steps item'>
                            ...
                            <div className='my-2'>
                                ...
                                <p className='owlp'>Understanding client needs and defining project scope for UI/UX design services.</p>
                            </div>
                        </div>
                        <div className='steps item'>
                            <div>
                            ...
                            <div className='my-2'>
                                ...
                                <p className='owlp'>Creating user-centric designs and prototypes that enhance usability and engagement.</p>
                            </div>
                        </div>
                        <div className='steps item'>
                            <div>
                            ...
                            <div className='my-2'>
                                ...
                                <p className='owlp'>Collaborating with developers to ensure design integrity during the implementation phase.</p>
                            </div>
                        </div>
                        <div className='steps item'>
                            <div>
                            ...
                            <div className='my-2'>
                                ...
                                <p className='owlp'>Conducting thorough testing to ensure the design meets user expectations and functionality.</p>
                            </div>
                        </div>
                        <div className='steps item'>
                            <div>
                            ...
                            <div className='my-2'>
                                ...
                                <p className='owlp'>Launching your UI/UX design and providing ongoing support for continuous improvement.</p>
                            </div>
                        </div>
                    </OwlCarousel>
                </div>
            ...
            <section className="servicetech ourtechstack" id="techstacks" data-aos="fade-up">
                <Container>
                    <div className="sectiontitle">
                        <h3 className="sectitl text-center">Technologies We Use for UI/UX Design</h3>
                    </div>
                    <div className="whatwesect mb-3">
